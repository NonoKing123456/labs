...
# for use in some CS202 labs (and before that, UT CS439 labs)
...
class Runner():
    ...
    def run_test(self, binary):
        p = Popen(["stdbuf", "-o0", "-e0", binary], stderr=subprocess.STDOUT, stdout=subprocess.PIPE, encoding="utf8")
    ...
    def match(self, *args, **kwargs):
        ...
        def save_on_finish(fail):
            ...
            if test.parent:
                first_name = test.parent.__name__.replace("test_", "")
